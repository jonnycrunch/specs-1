...
func (st *StorageMinerActorState_I) _getSectorDealIDsAssert(sectorNo abi.SectorNumber) deal.DealIDs {
...
func MinerInfo_New(
	ownerAddr addr.Address, workerAddr addr.Address, sectorSize abi.SectorSize, peerId libp2p.PeerID) MinerInfo {
